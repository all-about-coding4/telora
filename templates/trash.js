      ...
      const STORAGE_KEY = 'minimalChatUser';
      const FRIENDS_KEY = 'minimalChatFriends';
      const RECENT_KEY = 'minimalChatRecent';
    ...
    regError.textContent = data.msg;  
      ...
      function renderMessages(messages) {  
        ...
        for (let msg of messages) {  
          const timeStr = msg.time || "just now";  
          const wrapperClass = msg.sender === user_data.userid ? 'message-wrapper me' : 'message-wrapper other';  
          if (msg.type === 'text') {  
